        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-itm active">Gestionar Preñez</li>
                </ol>
            </div>
...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="btn-agregar-prenez btnAgregar">
            <button type="button" class="btn btn-info btn-sm mb-4" data-toggle="modal" data-target="#modal-gestionar-categoria" data-dismiss="modal"><i class="fas fas-plus-square">Agregar Preñez</i></button>
        </div>
        <table id="tablaPrenez" class="table table-striped table-bordered nowrap" style="width: 100%;">
...
<div class="modal fade" id="modal-gestionar-prenez">
...
<script>
    ...
    $(document).ready(function(){
       ...
       /*$.ajax({
        ...
        var table = $('#tablaPrenez').DataTable({
